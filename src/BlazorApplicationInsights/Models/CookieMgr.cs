...
public class CookieMgr(IJSRuntime jSRuntime) {
	...
	public async Task SetEnabled(bool value) {
		await this.JSRuntime.InvokeVoidAsync("blazorApplicationInsights.cookieMgrSetCookiesEnabled", value);
	}
	...
	public async Task<bool> IsEnabled() {
		return await this.JSRuntime.InvokeAsync<bool>("blazorApplicationInsights.cookieMgrGetCookiesEnabled");
	}
	...
	public async Task<bool> Set(string name, string value, int? maxAgeSec = null, string? domain = null, string? path = null) {
		return await this.JSRuntime.InvokeAsync<bool>("blazorApplicationInsights.cookieMgrSet", name, value, maxAgeSec, domain, path);
	}
	...
	public async Task<string> Get(string name) {
		return await this.JSRuntime.InvokeAsync<string>("blazorApplicationInsights.cookieMgrGet", name);
	}
	...
	public async Task<bool> Del(string name, string? path = null) {
		return await this.JSRuntime.InvokeAsync<bool>("blazorApplicationInsights.cookieMgrDel", name, path);
	}
	...
	public async Task<bool> Purge(string name, string? path = null) {
		return await this.JSRuntime.InvokeAsync<bool>("blazorApplicationInsights.cookieMgrPurge", name, path);
	}
	...
	public async Task Unload(bool? isAsync) {
		await this.JSRuntime.InvokeVoidAsync("blazorApplicationInsights.cookieMgrUnload", isAsync);
	}
}