...
public partial class ApplicationInsightsInit {
	...
	protected override async Task OnAfterRenderAsync(bool firstRender) {
		...
		if (firstRender) {
			this.ApplicationInsights.InitJSRuntime(this.JSRuntime);
		}
		...
		if (firstRender && this.Config.OnAppInsightsInit != null) {
			await this.Config.OnAppInsightsInit(this.ApplicationInsights);
		}
	}
